                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            Padding(
                              child: Text(
                                  widget.articleData.author == ""
                                      ? widget.articleData.shareUser
                                      : widget.articleData.author,
                                  style: TextStyle(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          if (this.widget.isHomeShow) {
                            print("跳转 知识体系下文章 ");
                            Application.router.navigateTo(context,
                                '${Routes.knowledgedetail}?type=${Uri.encodeComponent(Constants.RESULT_CODE_LATEST_PROJECT_PAGE)}&articleJson=${ToolUtils.object2string(widget.articleData)}');
                          }
                        },
                      )))
            ],
